...
Further information can be found in the other [vignettes](https://cran.r-project.org/package=mitml) and the package [documentation](https://cran.r-project.org/package=mitml/mitml.pdf).
